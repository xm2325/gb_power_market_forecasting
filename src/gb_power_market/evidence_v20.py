...
def build_evidence_bundle(project_root: Path, report_dir: Path, out_dir: Path, *, generated_at_utc: str | None = None) -> dict[str, Any]:
    ...
    _write_cv_summary(out_dir / "V0_20_CV_SAFE_SUMMARY.md", payload)
    _write_interview_summary(out_dir / "V0_20_INTERVIEW_SAFE_SUMMARY.md", payload)
    _write_failure_diagnostic(out_dir / "V0_20_FAILURE_DIAGNOSTIC.md", payload)
    return payload
